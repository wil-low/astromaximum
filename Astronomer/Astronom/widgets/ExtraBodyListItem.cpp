#include "ExtraBodyListItem.h"
#include "../utils/DMS.h"
#include "../labels/AstroLabel.h"
#include "../Astronom.h"
#include "../utils/GlyphManager.h"

FXIMPLEMENT(ExtraBodyListItem, FXListItem, NULL, 0)

ExtraBodyListItem::ExtraBodyListItem (int id)
: FXListItem("0", NULL, NULL)
, deg_mode_(dm_Absolute)
, body_id_(id)
{
}

ExtraBodyListItem::~ExtraBodyListItem(void)
{
}

void ExtraBodyListItem::setDegMode(const FXList* list, deg_mode dm)
{
    deg_mode_ = dm;
...
void ExtraBodyListItem::draw(const FXList* list, FXDC& dc, FXint xx, FXint yy, FXint ww, FXint hh) const
{
