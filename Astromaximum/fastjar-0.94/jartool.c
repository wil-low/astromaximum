...
/* $Id: jartool.c,v 1.7 2007/02/06 03:27:12 toast Exp $

  $Log: jartool.c,v $
  Revision 1.7  2007/02/06 03:27:12  toast

  merged all the patches from sf.net

  Revision 1.6  2000/12/14 23:23:40  toast
...
static char rcsid[] = "$Id: jartool.c,v 1.7 2007/02/06 03:27:12 toast Exp $";
    ...
    while ((arg = get_next_arg ())){
      ...
      if(!strcmp(arg, "-C")){
        ...
        if (add_to_jar(jarfd, dir_to_change, file_to_add)) {
          fprintf(stderr, "Error adding %s (in directory %s) to jar archive!\n",
