...
static const unsigned char OWN_SIGN_REVERSE[12] ={SE_MARS, SE_VENUS, SE_MERCURY, SE_MOON, SE_SUN, SE_MERCURY,
    SE_VENUS, SE_MARS, SE_JUPITER, SE_SATURN, SE_SATURN, SE_JUPITER};
static const unsigned char EXALTATION[7] ={0, 1, 5, 11, 9, 3, 6};
static const unsigned char EXALTATION_REVERSE[12] ={SE_SUN, SE_MOON, 100, SE_JUPITER, 100, SE_MERCURY,
...
static const char DECANES[7] ={SE_MARS, SE_SUN, SE_VENUS, SE_MERCURY, SE_MOON, SE_SATURN, SE_JUPITER};
...
void DataFile::init(sEphRecord *ephdata, double start, unsigned int count) {
    ...
    startJD = start;
    dayCount = count;
    stepCount = (int) (count / MINUTE_STEP);
    ephData = ephdata;
}
