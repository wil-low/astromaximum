 ...
 *
 * Created on 12 Декабрь 2006 г., 21:15
 */
...
class LocalizationSupport  {
     ...
     */
    private static boolean initLocalizationSupport() {
    ...
    public static boolean initLocalizationSupport(String locale) {
        ...
        final Class clazz = Runtime.getRuntime().getClass();
        try {
            // try to find localized resource first (in format ${name}_locale.${suffix})
            if (locale != null && locale.length() > 1) {
                final int lastIndex = _MESSAGES_BUNDLE.lastIndexOf('.');
                final String prefix = _MESSAGES_BUNDLE.substring(0,lastIndex);
                final String suffix = _MESSAGES_BUNDLE.substring(lastIndex);
  ...
  /**
    ...
    private static String getMessage(String key, Object[] args) {
        ...
        final String s = (String) _messageTable.get(key);
        if (s == null) {
          return _DEFAULT_STRING;
        }
     ...
     * @noinspection ValueOfIncrementOrDecrementUsed,HardcodedFileSeparator
     */
     ...
     * @noinspection AssignmentToForLoopParameter,ValueOfIncrementOrDecrementUsed,HardcodedFileSeparator
     */
