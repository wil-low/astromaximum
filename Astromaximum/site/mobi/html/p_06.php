...
if(!isset($EXEC)){ // don't show Plimus button when in popup
...
echo <<< EOF
<a href="$svc_url" target="_blank" title="Trusted and Secure Online Payment Processing via PLIMUS"><img src="http://www.plimus.com/images/icons_wizard/icons/cards/cards_type2_2-5.gif" border="0"></a>
EOF;
